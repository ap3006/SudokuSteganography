 ...
 */
public class SudokuStegController
{
	//Program Variables
	private SudokuStegView	view;
	private SudokuSteganography	model;
	 ...
	 */
	public SudokuStegController(SudokuStegView aView, SudokuSteganography aModel)
	{
		//program variables
		view  = aView;
		model = aModel;
	...
	{
		new SudokuStegController(
									new SudokuStegView("Steganography"),
									new SudokuSteganography()
									);
	}
}
